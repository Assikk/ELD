<template>
  <div class="scrollbar overflow-y-auto h-[580px] flex flex-col gap-4 pr-2">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
      ...
      :error="(v.form.password.$dirty && !v.form.password.requiredIfPassword) || (v.form.password.$dirty && !v.form.password.minLength)">
        <template #error>
          <span v-if="v.form.password.$dirty && !v.form.password.requiredIfPassword">
            Write Password
          </span>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
      ...
      :error="(v.form.password2.$dirty && !v.form.password2.requiredIfPassword2) || (v.form.password2.$dirty && !v.form.password2.minLength)">
        <template #error>
          <span v-if="v.form.password2.$dirty && !v.form.password2.requiredIfPassword2">
            Confirm Password
          </span>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
      ...
      :error="v.form.license_issuing_state.$dirty && !v.form.license_issuing_state.required">
        <template #error>
          <span v-if="v.form.license_issuing_state.$dirty && !v.form.license_issuing_state.required">
            Choose driver's license issuing state
          </span>
        </template>
      </Select>
    </div>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters({
      vehiclesWithoutDriver: 'vehicles/vehiclesWithoutDriver',
